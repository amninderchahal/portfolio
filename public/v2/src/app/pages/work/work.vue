...
<div class="section work-page">
    <div class="content-wrapper work-section container-fluid">
        ...
        <div class="learn-more">
            <p>If you'd like to find out more about my work experience, feel free to <a href="#/contact">contact me</a>.</p>
...
<script>
import ProjectLinkItem from '../../components/project-link-item';
